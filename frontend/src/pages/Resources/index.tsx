        ...
        <div className="section-container">
          <motion.div variants={sectionHeaderVariants} initial="hidden" animate="visible" className="text-center pt-16">
            ...
            <h1 className="font-heading text-5xl md:text-6xl font-black text-white mb-6">
              <span className="gradient-text">Free Resources</span>
            </h1>
            <p className="text-white/45 text-lg max-w-2xl mx-auto">Premium trading resources, PDFs, and guides — all free.</p>
          </motion.div>
        </div>
      </section>
    </motion.main>
